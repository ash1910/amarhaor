        ...
        <div class="modal-body" style="background-color: rgba(0, 182, 94, .1);">
          <div class="row">
             <div class="col-xs-12 col-md-8">
              ...
              <p style="text-align: justify;" class="haorDescription"></p>
            </div>
            <div class="col-xs-12 col-md-4">
              <p><strong>About:</strong></p>
              <p style="text-align: justify;" class="haorAbout"></p>
              <p><strong>Designations:</strong></p>
              <p style="text-align: justify;" class="haorDesignations"></p>
              <p><strong>Location:</strong></p>
              <p style="text-align: justify;" class="haorLocation"></p>
              <p><strong>Area:</strong></p>
              <p style="text-align: justify;" class="haorArea"></p>
            </div>
          </div>
        </div>
        <div class="modal-footer" style="background-color: rgba(0, 182, 94, .2);">
