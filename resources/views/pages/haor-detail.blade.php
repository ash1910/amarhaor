          ...
          <div class="row justify-content-center">
            <div class="col-xl-10">
              <div class="haor_navigation_inner">
                <a href="/haor-detail/{{ @$prev_haor_id }}" class="navigation_item previous">
                  <span class="label">previous haor</span>
                  <h2 class="haor_name">{{ @$prev_haor_name }}</h2>

                  <span class="haor_arrow"></span>
                </a>

                <a href="/haor-detail/{{ @$next_haor_id }}" class="navigation_item next">
                  <span class="label">next haor</span>
